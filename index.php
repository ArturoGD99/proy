<?php
    ...
    incluirTemplate('header',$inicio=true,$texto=true);
?>
    ...
    <section class="imagen-contacto">
        ...
        <a href="contacto.html" class="boton-amarillo-inline">Contactános</a>
    </section>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="entrada.html">
                        ...
                        <p class="informacion-meta">Escrito el: <span>201/10/2021</span> por: <span>Admin</span></p>
